...
%\def\NameBoldface#1{\textbf{#1}} % Makes the name and role at the top of each person's biographical sketch bold-faced; change {\textbf{#1}} to {#1} or to other preference.
%\def\NameColor{Blue} % Color of the name and role at the top of each person's biographical sketch
%\def\NameSize{\large } % SIze of the name and role at the top of each person's biographical sketch
%\def\LabelBoldface#1{\textbf{#1}} % Makes the category labels ("Edicuation", "Appointments", etc) in  each person's biographical sketch bold-faced; change {\textbf{#1}} to {#1} or to other preference.
%\def\SectionSpacing{\par \vspace{-0.5em}} % Vertical spacing between the categories within a person's biographical sketch
%\def\PublicationBullet{{\scriptsize{$\bullet$}} } % Symbol that goes in front of each item in publication list
%%
...
\NameBoldface{\color{\NameColor}{\NameSize Dr. Daniel Dent{\'o}n (Principal Investigator):}}\\
University of CBA
\SectionSpacing
...
{\PublicationBullet}Lopez-Rodriguez, E., Mao, S.A., Beck, R., et al. (inc. \textbf{Denton, D.}), 2022, "Extragalactic magnetism with SOFIA (SALSA Legacy Program) IV: Program overview and first results on the polarization fraction" (submitted to ApJ)\\
{\PublicationBullet}Young, E.T., Herter, T.L., Gusten, R., et al. (inc. \textbf{Denton, D.}), 2021, "Early science results from SOFIA", 8444, 844410\\
{\PublicationBullet}Miles, J.W., Helton, L.A, Sankrit, R., et al. (inc. \textbf{Denton, D.}), 2018, "Capabilities, performance, and status of the SOFIA science instrument suite", SPIA, 8867, 88670N\\
{\PublicationBullet}Temi, P., \textbf{Denton, D.}, Miller, W.E., et al., 2018, "SOFIA observatory performance and characterization", SPIE, 84444, 8444414\\
{\PublicationBullet}Gehrz, R.D., Becklin, E.E., et al. (inc.\textbf{Denton, D.}), 2015, "Status of the Stratospheric Observatory for Infrared Astronomy (SOFIA)", Adv. in Space Research, 48, 1004\\
{\PublicationBullet}\textbf{Denton, D.}, Appleton, P.N., Higdon, J.L, 2010, "Large Infrared and Optical Color Gradients in the Carwheel Ring Galaxy: Evidence fo rthe First Epoch of Star Formation in the Wake of an Expanding Ring", ApJ, 399, 57
\medskip \hrule \vspace{5pt} \medskip
\NameBoldface{\color{\NameColor}{\NameSize Dr. Sally Smith (Science PI):}}\\
University of CBA
\SectionSpacing
\LabelBoldface{Education}\\
...
\SectionSpacing
\LabelBoldface{Publications relevant for the proposal:}\\
{\PublicationBullet}Lopez-Rodriguez, E., Mao, S.A., Beck, R., et al. (inc. \textbf{Smith, S.}), 2022, "Extragalactic magnetism with SOFIA (SALSA Legacy Program) IV: Program overview and first results on the polarization fraction" (submitted to ApJ)\\
{\PublicationBullet}Young, E.T., Herter, T.L., Gusten, R., et al. (inc. \textbf{Smith, S.}), 2021, "Early science results from SOFIA", 8444, 844410\\
{\PublicationBullet}Gehrz, R.D., Becklin, E.E., et al. (inc.\textbf{Smith, S.}), 2015, "Status of the Stratospheric Observatory for Infrared Astronomy (SOFIA)", Adv. in Space Research, 48, 1004\\
{\PublicationBullet}\textbf{Smith, S.}, Appleton, P.N., Higdon, J.L, 2010, "Large Infrared and Optical Color Gradients in the Carwheel Ring Galaxy: Evidence fo rthe First Epoch of Star Formation in the Wake of an Expanding Ring", ApJ, 399, 57
\medskip \hrule \vspace{5pt} \medskip
\NameBoldface{\color{\NameColor}{\NameSize Dr. Pamela M. Marcum (co-Investigator):}}\\
NASA ARC
\SectionSpacing
\LabelBoldface{Education}\\
...
\SectionSpacing
\LabelBoldface{Publications relevant for the proposal:}\\
{\PublicationBullet}Ashley, T., \textbf{Marcum, P.M.}, Alpaslan, M., Fanelli, M.N., Frost, J.D., 2019, "The Neutral Gas Properties of Extremely Isolated Early-type Galaxies III", AJ, 157, 158\\
{\PublicationBullet}Alpaslan, M., Grootes, M.W., \textbf{Marcum, P.M.}, et al., 2016, "Galaxy And Mass Assembly (GAMA): Stellar mass growth of spiral galaxies in the cosmic web", MNRAS, 457, 2287\\
{\PublicationBullet}van Driel, W., \textbf{Marcum, P.M.}, Gallagher, J.S., et al., 2001, "HI observations of loose galaxy groups I. Data and global properties", A\&A, 378, 370
\medskip \hrule \vspace{5pt} \medskip