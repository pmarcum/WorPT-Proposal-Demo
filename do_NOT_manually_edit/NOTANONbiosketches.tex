...
\myNameBoldface{\color{\myNameColor}\myNameSizeDr. Daniel Dent{\'o}n (Principal Investigator):}\\
University of CBA
\par \vspace{-0.5em}
...
\myNameBoldface{\color{\myNameColor}\myNameSizeDr. Sally Smith (Science PI):}\\
University of CBA
\par \vspace{-0.5em}
\myLabelBoldface{Education}\\
...
\medskip \hrule \vspace{5pt} \medskip
\myNameBoldface{\color{\myNameColor}\myNameSizeDr. Pamela M. Marcum (co-Investigator):}\\
NASA ARC
\par \vspace{-0.5em}
\myLabelBoldface{Education}\\
