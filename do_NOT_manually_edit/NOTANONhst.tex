...
\myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Contributor} & \myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Position} \newline{\myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Institution}\newline{\myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}US/Foreign}}} & \myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Role} & \myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}\$?} & \myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}FTE}\\
\hline\hline
