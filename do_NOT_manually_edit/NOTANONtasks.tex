...
\hline
\myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Tasks} & \myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Lead}  &\myLabelBoldface{\cellcolor{\myHeaderColor}\color{\myLabelColor}Expertise}\\
\hline
\multicolumn{3}{|c|}{\cellcolor{\mySectionColor}\color{\myTaskColor}\myTaskBoldface{Task A: Data and models preparation}}\\
\hline
...
\hline
\multicolumn{3}{|c|}{\cellcolor{\mySectionColor}\color{\myTaskColor}\myTaskBoldface{Task B: Application to archive}}\\
\hline
B1: {Determine fields of interest} & Marcum & Smith, Dent{\'{o}}n, Gala\\
\hline
B2: {Reduction of image mosaics} & Dent{\'{o}}n & Smith, Gala\\
\hline
\multicolumn{3}{|c|}{\cellcolor{\mySectionColor}\color{\myTaskColor}\myTaskBoldface{Task C: Documentation and publications}}\\
\hline
