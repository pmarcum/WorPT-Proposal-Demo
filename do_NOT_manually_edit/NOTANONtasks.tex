...
\hline
\multicolumn{3}{|c|}{\cellcolor{\SectionColor}\color{\TaskColor}\TaskBoldface{Task A: Data and models preparation}}\\
\hline
...
\hline
\multicolumn{3}{|c|}{\cellcolor{\SectionColor}\color{\TaskColor}\TaskBoldface{Task B: Application to archive}}\\
\hline
B1: {Determine fields of interest} & Marcum & Smith, Dent{\'{o}}n, Gala\\
\hline
B2: {Reduction of image mosaics} & Dent{\'{o}}n & Smith, Gala\\
\hline
\multicolumn{3}{|c|}{\cellcolor{\SectionColor}\color{\TaskColor}\TaskBoldface{Task C: Documentation and publications}}\\
\hline
C1: {Code documentation \& verification} & Smith & Marcum, Dent{\'{o}}n\\
\hline
C2: {Pub 1: pipeline and improved images} & Dent{\'{o}}n & Smith, Marcum, Gala\\
\hline
C3: {Pub 2: galaxy identifications} & Marcum & Smith, Dent{\'{o}}n, Gala
\\ \hline