...
%\def\myNoDollarColumnIcon{\noDollarIcon[-0.2][0.4mm][0.2][0.15]}  % Size of "no dollar" symbol column label
%\def\myDollarColumnIcon{\dollarIcon[-0.3][0.2][0.015]}  % Size of "no dollar" symbol column label
%%
