...
%          \makeatletter \def\expinput#1{\@@input#1} \makeatother % needed when part of table content is inserted by \input
%          \usepackage{array} \usepackage{longtable} \usepackage{fontawesome} \usepackage{tikz}
%          \usepackage{rotating}
%          \usetikzlibrary{shapes.multipart} \usetikzlibrary{arrows.meta, positioning, fit, shapes.misc}
%          \usetikzlibrary{tikzmark,overlay-beamer-styles,bending} \usepackage{colortbl} \usepackage{tablefootnote}
