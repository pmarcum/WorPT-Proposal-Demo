...
%\def\mySigmaColumnSize{\scriptsize } % Size of Sigma symbol column label
%\def\myNoDollarColumnSize{{\raisebox{-0.3\normalbaselineskip}[0pt][0pt]{\begin{tikzpicture}  % Size of "no dollar" symbol column label
...
& {\myNoDollarColumnSize } % Col2 Total FTE
& {\raisebox{-0.3\normalbaselineskip}[0pt][0pt]{\begin{tikzpicture}
