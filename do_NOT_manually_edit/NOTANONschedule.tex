...
\myFteTotalFteFormat{0.27} & \myFteUnfundedFteFormat{0.04} & \myFteFundedFormat{0.23}\\
%beginning level 2 task
...
\myFteTotalFteFormat{0.23} & \myFteUnfundedFteFormat{0.00} & \myFteFundedFormat{0.23}\\
%beginning level 2 task
...
\myFteTotalFteFormat{0.19} & \myFteUnfundedFteFormat{0.08} & \myFteFundedFormat{0.12}\\
\hline
%beginning level 1 task
...
\myFteTotalFteFormat{0.15} & \myFteUnfundedFteFormat{0.12} & \myFteFundedFormat{0.04}\\
%beginning level 2 task
...
\myFteTotalFteFormat{0.23} & \myFteUnfundedFteFormat{0.10} & \myFteFundedFormat{0.13}\\
\hline
%beginning level 1 task
...
\myFteTotalFteFormat{0.33} & \myFteUnfundedFteFormat{0.12} & \myFteFundedFormat{0.21}\\
%beginning level 2 task
...
\myFteTotalFteFormat{0.31} & \myFteUnfundedFteFormat{0.12} & \myFteFundedFormat{0.19}\\
%beginning level 2 task
