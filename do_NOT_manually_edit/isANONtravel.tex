...
\multicolumn{3}{|c}{} & \multicolumn{5}{>{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][7pt]}c}{\color{\myPerTripLabelFontColor}\emph{\textbf{per trip}}} & \\
\cline{4-8}
