...
%   \begin{tabular}{|lcl >{\myPerTripShading}c>{\myPerTripShading}c>{\myPerTripShading}l>{\myPerTripShading}l>{\myPerTripShading}ll|}
...
\multicolumn{3}{|c}{} & \multicolumn{5}{>{{\myPerTripShading}c}{\color{\myPerTripLabelFontColor}\emph{\textbf{per trip}}} & \\
\cline{4-8}
