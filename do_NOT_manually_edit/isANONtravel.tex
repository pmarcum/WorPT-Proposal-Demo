...
%\def\myPerTripShading{\columncolor[gray]{0.85}[\tabcolsep][7pt]} % Color shading of the columns under the "per trip" section, where 2nd parameter is the opacity
...
%   \begin{tabular}{|lcl >{\columncolor[gray]{0.85}[\tabcolsep][7pt]}c>{\columncolor[gray]{0.85}[\tabcolsep][7pt]}c>{\myPerTripShading}l>{\myPerTripShading}l>{\myPerTripShading}ll|}
...
\multicolumn{3}{|c}{} & \multicolumn{5}{>{\columncolor[gray]{0.85}[\tabcolsep][7pt]}c}{\color{\myPerTripLabelFontColor}\emph{\textbf{per trip}}} & \\
\cline{4-8}
