...
%\def\myPerTripShadingColor{gray} % Color of shading of the columns under the "per trip" section
%\def\myPerTripShadingOpacity{0.85} % Opacity of shading of the columns under the "per trip" section (0 - completely transparent, 1.0 - completely opaque)
%\def\myPerTripShadingMargin{7pt} % WIdth of margin to right of each shaded column under the "per trip" section. A white vertical line will show if this value is too small.
...
%   \begin{tabular}{|lcl >{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][\myPerTripShadingMargin]}c>{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][\myPerTripShadingMargin]}c>{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][\myPerTripShadingMargin]}l>{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][\myPerTripShadingMargin]}l>{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][\myPerTripShadingMargin]}ll|}
...
\multicolumn{3}{|c}{} & \multicolumn{5}{>{\columncolor[\myPerTripShadingColor]{\myPerTripShadingOpacity}[\tabcolsep][myPerTripShadingMargin]}c}{\color{\myPerTripLabelFontColor}\emph{\textbf{per trip}}} & \\
\cline{4-8}
