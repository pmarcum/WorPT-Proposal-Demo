...
%======================================================
\hline
\multicolumn{5}{|@{}c@{}|}{\cellcolor{Blue}\color{white}\textbf{Equipment, Travel, Supplies, Page Charges}}\\  % top header line
\textbf{\color{Blue}Cost Category} & \textbf{\color{Blue}Y1} & \textbf{\color{Blue}Y2} & \textbf{\color{Blue}Y3} & \textbf{\color{Blue}{Total}}\\ % second header line
\hline
