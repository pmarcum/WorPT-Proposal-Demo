...
%\def\fm1#1{\textbf#1} % Format for all budget amounts not under "Total" and not in the Travel's "domestic" and "international" break-outs; to remove boldface, replace {\textbf#1} with {#1} or with other desired mark-up
%\def\fm2#1{\textit#1} % Format of budget amounts under the Travel's "domestic" and "international" break-outs that are not Total values; to remove format, replace {\textit#1} with {#1} or with other desired mark-up
%\def\fm3#1{\textbf#1} % Format of budget amounts under Total that are not in the "Domestic" and "International" break-outs; to remove boldface, replace {\textbf#1} with {#1} or with other desired mark-up
%\def\fm4#1{\textit#1} % Format of budget amounts under Total that are also under the "Domestic" or "International" break-outs; to remove format, replace {\textit#1} with {#1} or with other desired mark-up
%%
...
\hline
\textbf{Equipment} & \fm1{\$1,200} & \fm1{\$2,300} & \fm1{\$1,700} & \fm3{\$5,200}
\textbf{Travel} & \fm1{\$20,580} & \fm1{\$26,220} & \fm1{\$23,400} & \fm3{\$70,200}
\textit{~~~Domestic} & \fm2{\$11,280} & \fm2{\$16,920} & \fm2{\$14,100} & \fm4{\$42,300}
\textit{~~~International} & \fm2{\$9,300} & \fm2{\$9,300} & \fm2{\$9,300} & \fm4{\$27,900}
\textbf{Materials \& Supplies} & \fm1{\$300} & \fm1{\$300} & \fm1{\$300} & \fm3{\$900}
\textbf{Publication Costs} & \fm1{\$3,400} & \fm1{\$3,600} & \fm1{\$4,400} & \fm3{\$11,400}
\hline