...
%\def\BannerFontColor{Blue} % Color of the text in the banner at the top "Equipment, Travel, Supplies, Page Charges"
...
{\ColumnBoldface{\color{\CostLabelColor}{Cost Category}}} & {\ColumnBoldface{\color{\YearLabelColor}{Y1}}} & {\ColumnBoldface{\color{\YearLabelColor}{Y2}}} & {\ColumnBoldface{\color{\YearLabelColor}{Y3}}} & {\TotalBoldface{\color{\TotalLabelColor}{Total}}}\\ % second header line
\hline
