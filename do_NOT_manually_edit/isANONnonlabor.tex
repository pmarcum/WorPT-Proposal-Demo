...
%\def\fmtA#1{\textbf{#1}} % Format for all budget amounts not under "Total" and not in the Travel's "domestic" and "international" break-outs; to remove boldface, replace {\textbf#1} with {#1} or with other desired mark-up
%\def\fmtB#1{\textit{#1}} % Format of budget amounts under the Travel's "domestic" and "international" break-outs that are not Total values; to remove format, replace {\textit#1} with {#1} or with other desired mark-up
%\def\fmtC#1{\textbf{#1}} % Format of budget amounts under Total that are not in the "Domestic" and "International" break-outs; to remove boldface, replace {\textbf#1} with {#1} or with other desired mark-up
%\def\fmtD#1{\textit{#1}} % Format of budget amounts under Total that are also under the "Domestic" or "International" break-outs; to remove format, replace {\textit#1} with {#1} or with other desired mark-up
%%
...
\hline
\textbf{Equipment} & \fmtA{\$1,200} & \fmtA{\$2,300} & \fmtA{\$1,700} & \fmtC{\$5,200}\\
\textbf{Travel} & \fmtA{\$20,580} & \fmtA{\$26,220} & \fmtA{\$23,400} & \fmtC{\$70,200}\\
\textit{~~~Domestic} & \fmtB{\$11,280} & \fmtB{\$16,920} & \fmtB{\$14,100} & \fmtD{\$42,300}\\
\textit{~~~International} & \fmtB{\$9,300} & \fmtB{\$9,300} & \fmtB{\$9,300} & \fmtD{\$27,900}\\
\textbf{Materials \& Supplies} & \fmtA{\$300} & \fmtA{\$300} & \fmtA{\$300} & \fmtC{\$900}\\
\textbf{Publication Costs} & \fmtA{\$3,400} & \fmtA{\$3,600} & \fmtA{\$4,400} & \fmtC{\$11,400}\\
\hline